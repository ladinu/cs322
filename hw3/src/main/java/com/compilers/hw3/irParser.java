...
// Program -> {Data} {Func}
//
  final public IR.Program Program() throws ParseException {
...
//
  final public IR.Data Data() throws ParseException {
...
// Const -> Global | IntLit
// 
  final public IR.Const Const() throws ParseException {
  IR.Const c;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case Global:
      c = Global();
...
//         "{" {Inst | <EOL>} "}" <EOL>  // Body
//
  final public IR.Func Func() throws ParseException {
  IR.Type type=null;
  IR.Global g;
  IR.Inst inst;
  List<String> params;
  ...
  final public IR.Type Type() throws ParseException {
...
// VarList -> "(" [<Id> T{"," <Id>}] ")"
//
  final public List<String> VarList() throws ParseException {
  Token t;
  IR.Type type=null;
...
//         ) <EOL>
//
  final public IR.Inst Inst() throws ParseException {
  IR.Label lab;
  IR.Type type=null;
  IR.BOP bop=null;
  IR.RelOP rop=null;
...
// ArgList -> "(" [Src {"," Src}] ")"
//
  final public List<IR.Src> ArgList() throws ParseException {
  ...
  final public IR.ArithOP ArithOP() throws ParseException {
  IR.ArithOP op=null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 33:
      jj_consume_token(33);
  ...
  final public IR.RelOP RelOP() throws ParseException {
  IR.RelOP op=null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 38:
      jj_consume_token(38);
  ...
  final public IR.BOP BOP() throws ParseException {
  IR.BOP op;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 32:
    case 33:
  ...
  final public IR.UOP UOP() throws ParseException {
  IR.UOP op=null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 34:
      jj_consume_token(34);
  ...
  final public IR.Label Label() throws ParseException {
  Token t;
    t = jj_consume_token(Id);
...
// Addr -> [IntLit] "[" Dest "]"
//
  final public IR.Addr Addr() throws ParseException {
...
//
  final public IR.Src Src() throws ParseException {
  IR.Src src;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case Id:
      src = Id();
...
// Dest -> Id | Temp  
//
  final public IR.Dest Dest() throws ParseException {
  IR.Dest dst;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case Id:
      dst = Id();
...
//
  final public IR.CallTgt CallTgt() throws ParseException {
  IR.CallTgt tgt;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case Id:
      tgt = Id();
  ...
  final public IR.Id Id() throws ParseException {
  Token t;
    t = jj_consume_token(Id);
  ...
  final public IR.Temp Temp() throws ParseException {
  Token t; String s;
  ...
  final public IR.Global Global() throws ParseException {
  Token t;
  ...
  final public IR.IntLit IntLit() throws ParseException {
  Token t;
  ...
  final public IR.BoolLit BoolLit() throws ParseException {
  Token t;
  ...
  final public IR.StrLit StrLit() throws ParseException {
  Token t;
